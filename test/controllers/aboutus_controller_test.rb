...
class AboutusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aboutu" do
    assert_difference('Aboutu.count') do
      post aboutus_url, params: { aboutu: { address: @aboutu.address, city: @aboutu.city, country: @aboutu.country, phone: @aboutu.phone, state: @aboutu.state } }
    end
  ...
  test "should update aboutu" do
    patch aboutu_url(@aboutu), params: { aboutu: { address: @aboutu.address, city: @aboutu.city, country: @aboutu.country, phone: @aboutu.phone, state: @aboutu.state } }
